var contextMenuChangeToLine = {
    ...
    contextMenuForShape = [contextMenuChangeToMove, contextMenuChangeToLine, contextMenuChangeToQuadratic, contextMenuChangeToBezier, contextMenuAddPoint, contextMenuRemovePoint];